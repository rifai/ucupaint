...
class YBakeAllTargets(bpy.types.Operator, BaseBakeOperator):
    ...
    #     print("Baking custom target...", yp.active_bake_target_index)
    #     bt = yp.bake_targets[yp.active_bake_target_index]
        
    #     r: YBakeTargetChannel = bt.r
    #     g: YBakeTargetChannel = bt.g
    #     b: YBakeTargetChannel = bt.b
    #     a: YBakeTargetChannel = bt.a

    #     print(" R:"+ r.channel_name+",", r.subchannel_index,",", r.default_value,",", r.normal_type,",", r.invert_value)
    #     print(" G:"+ g.channel_name+",", g.subchannel_index,",", g.default_value,",", g.normal_type,",", g.invert_value)
    #     print(" B:"+ b.channel_name+",", b.subchannel_index,",", b.default_value,",", b.normal_type,",", b.invert_value)
    #     print(" A:"+ a.channel_name+",", a.subchannel_index,",", a.default_value,",", a.normal_type,",", a.invert_value)
